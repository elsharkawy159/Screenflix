...
import TVShowsGenres from "../GenresIDS/TVShowsGenres";
  ...
  async function discover(page, sortBy, genre, releaseYear) {
    ...
    try {
      let { data } = await axios.get(
        `https://api.themoviedb.org/3/discover/tv?api_key=c04c56b8aeb3dce3acdfd16eb3ca314b&language=en-US&${sortBy}&include_adult=false&include_video=false&page=${page}&${releaseYear}${genre}&with_watch_monetization_types=flatrate`
      );
      if (data && data.results) {
        setDiscoverTVShows(data.results);
      }
    } catch (error) {
      console.error(error);
    }
      ...
      <div className="container-fluid ">
        <div className="row ms-5 me-5">
          ...
          <div className="col-md-10 ms-auto mt-5 pt-5 me-0 row gy-4 justify-content-center">
            ...
            {discoverTVShows.map((media, index) => (
              <div
