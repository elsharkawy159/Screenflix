...
export default function NowPlayingMovies() {
  let { nowPlayingMovies, page, setpage, isLoading, getMovies } =
    ...
    <>
      <div className="container-fluid mt-5 pt-5">
        <div className="row gy-5 ms-5 me-5 justify-content-center">
          ...
          {nowPlayingMovies.map((media, index) => (
            <div
              className="col-md-2 col-sm-4 col-6 p-1 overflow-hidden pointer position-relative item"
              key={`${media.id}-${index}`}
            >
              {isLoading ? (
